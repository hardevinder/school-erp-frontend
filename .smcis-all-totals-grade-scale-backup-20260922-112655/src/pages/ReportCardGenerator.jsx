...
// SMCIS_HARDCODED_GRAND_TOTAL_ROUNDING_V1
// Print/display rule only: calculations, percentage, grade and stored marks remain decimal.
const roundSmcisGrandTotalForDisplay = (value) => {
 ...
 const getSubjectTermCompDisplay = (student, subjectName, termId, componentId) => {
  ...
  const buildSmartTemplateData = (student, infoOverride = {}) => {
    ...
    const displayGrandTotal = (value) =>
      isSmcisCodedTemplate ? roundSmcisGrandTotalForDisplay(value) : value;
  ...
  const buildTotalsFooterRowHtml = (student) => {
    ...
    const grandTotalForDisplay =
      selectedReportTemplate?.template_key === "smcis_dynamic_term_report_card_v1"
        ? roundSmcisGrandTotalForDisplay(grandTotal)
        : grandTotal;
                            ...
                            <tr>
                              ...
                              <td style={{ backgroundColor: "#e0f2fe" }}>
                                <div className="grand-total-small">
                                  {formatNumber(
                                    selectedReportTemplate?.template_key === "smcis_dynamic_term_report_card_v1"
                                      ? roundSmcisGrandTotalForDisplay(student.total_weighted)
