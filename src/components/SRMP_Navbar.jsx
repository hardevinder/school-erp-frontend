...
const Navbar = ({ notificationsCount = 0, onBellClick = () => {} }) => {
  ...
  const QUICK_LINKS_BY_ROLE = {
    admin: [
      ...
      { label: "Fee Cert", href: "/fee-certificates", icon: "bi-file-earmark-text" },
  ...
  // ✅ SRMP branding
  const brandLogo = `${process.env.PUBLIC_URL}/images/srmpLogo.png`;
  const brandName = "SHRI RAM PRASAD INTER COLLEGE";
  ...
  return (
    <>
          ...
          >
            ...
            {quickLinks.length > 0 && (
              <div className="d-flex align-items-center gap-2 gap-sm-3 me-2 quick-links-strip">
                {quickLinks.map((q) => {
                  // Special case: Pendings dropdown
      ...
      <style>{`
        ...
        .quick-link-icon.ql-active { color: var(--edb-primary-text) !important; }
        ...
        .quick-link-dropdown .dropdown-menu { min-width: 260px; padding: 0.25rem 0; }
        .quick-link-dropdown .dropdown-item { font-size: 0.8rem; padding: 0.35rem 0.8rem; }
        @media (min-width: 992px) { .btn.rounded-pill { line-height: 1.1; } }
