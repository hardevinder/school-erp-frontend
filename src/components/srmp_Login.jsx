...
// ✅ SRMP Background (fixed)
const BG_CANDIDATES = [`${process.env.PUBLIC_URL}/images/srmp.png`];
...
const Login = () => {
  ...
  // ✅ Fixed SRMP logo + name (no dynamic school fetch)
  const fallbackLogo = `${process.env.PUBLIC_URL}/images/srmpLogo.png`;
  const schoolLogoSrc = `${process.env.PUBLIC_URL}/images/srmpLogo.png`;
  const schoolName = "SHRI RAM PRASAD INTER COLLEGE";
