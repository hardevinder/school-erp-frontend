    ...
    if (isAccounts) {
      ...
      groups.push({
        ...
        items: [
          ...
          { key: "transportSummary", label: "Transport Summary", icon: "bi-truck-front", path: "/reports/transport-summary", roles: ["accounts"] },
    ...
    if (isAdmin) {
      ...
      groups.push({
        ...
        items: [
          ...
          { key: "enquiries", label: "Enquiries", icon: "bi-person-lines-fill", path: "/enquiries", roles: ["admin","superadmin"] },           // ✅ added
          { key: "transfer-certificates", label: "Transfer Certificates", icon: "bi-award", path: "/transfer-certificates", roles: ["admin","superadmin"] }, // ✅ added
