  ...
  return (
    <>
      <nav
        ...
        style={{
          zIndex: 3000,
          backgroundColor: "var(--edb-surface)", // ✅ WHITE BACKGROUND (IMAGE REMOVED)
        }}
      >
      ...
      <style>{`
        ...
        @media (prefers-color-scheme: dark) {
          .app-header { background-color: var(--edb-primary-dark) !important; }
          .navbar-brand span { color: var(--edb-on-primary); }
