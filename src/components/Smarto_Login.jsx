...
const BG_CANDIDATES = [
  ...
  `${process.env.PUBLIC_URL}/images/Smarto.jpg`,
  `${process.env.PUBLIC_URL}/image/Smarto.png`,
  `${process.env.PUBLIC_URL}/image/Smarto.jpg`,
];
...
const Login = () => {
  ...
  const schoolLogoSrc = school?.logo
    ? `${apiBase}${school.logo}`
    : `${process.env.PUBLIC_URL}/images/SmartoLogo.png`; // ✅ New Smarto Logo

  const schoolName = school?.name || "Smarto Experiential School";
  const fallbackLogo = `${process.env.PUBLIC_URL}/images/SmartoLogo.png`; // ✅ Fallback updated
