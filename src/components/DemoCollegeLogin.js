...
import "../pages/demoSchoolLogin.css";
...
const joinRooms = (user, roles = []) => {
  ...
  if (
    rl.includes("teacher") ||
    rl.includes("academic_coordinator") ||
    rl.includes("coordinator")
  ) {
  ...
  if (
    rl.includes("admin") ||
    rl.includes("superadmin") ||
    rl.includes("principal")
  ) {
...
const GoogleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 533.5 544.3" aria-hidden="true">
    ...
    <path
      fill="#EA4335"
      d="M272 107.7c39.2 0 74.5 13.5 102.2 39.9l76.7-76.7C404.8 26.2 344.2 0 272 0 168.8 0 77.8 54 33.7 153.2l88 69.6C142.9 154.9 202.1 107.7 272 107.7z"
    />
  </svg>
);
...
const EyeIcon = ({ open }) =>
  open ? (
    ...
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M3 3l18 18M10.6 6.2A10.5 10.5 0 0 1 12 6c6 0 9.5 6 9.5 6a17 17 0 0 1-2.2 2.9M6.1 7.3C3.8 9.1 2.5 12 2.5 12s3.5 6 9.5 6a10 10 0 0 0 4.1-.9M9.8 9.8a3.1 3.1 0 0 0 4.4 4.4"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
...
const CollegeLogin = () => {
  ...
  const afterAuth = async (data) => {
    ...
    const roleArrLower = roleArr.map((r) =>
      (r || "").toLowerCase()
    );
    ...
    try {
      ...
      window.dispatchEvent(
        new Event("family-updated")
      );
    } catch (e) {
      console.warn(
        "Failed to store family",
        e
      );
    }
  ...
  return (
    <main className="demo-login">
      ...
      <section
        ...
        aria-label="EduBridge Demo College"
      >
      ...
      <section className="demo-login__panel">
        ...
        <div className="demo-login__panel-inner">
          ...
          {error && (
            <div
              className="demo-login__alert"
              role="alert"
            >

              <span className="demo-login__alert-icon">
                !
              </span>
          ...
          >
            ...
            <div className="demo-login__field">
              ...
              <div className="demo-login__input-wrap">
                ...
                <span
                  className="demo-login__input-icon"
                  aria-hidden="true"
                >
                  <svg viewBox="0 0 24 24">
                    <path
                      d="M4 20c.8-4 3.4-6 8-6s7.2 2 8 6M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="1.7"
                      strokeLinecap="round"
          ...
          <div className="demo-login__security">
            ...
            <span
              className="demo-login__security-icon"
              aria-hidden="true"
            >
