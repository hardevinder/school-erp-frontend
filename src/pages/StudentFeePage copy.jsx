    ...
    <div className="container-fluid px-2 px-md-3" style={{ marginTop: 72 }}>
      ...
      <style>{`
        ...
        .transport-panel{
          ...
          border: 1 dashed color-mix(in srgb, var(--edb-border) 15%, transparent);
          border-radius: 12px;
          padding: .6rem .7rem;
        }
        .transport-badge{
        ...
        .shimmer .line{ height: 14px; background: linear-gradient(90deg,var(--edb-dashboard-bg) 25%,var(--edb-dashboard-bg) 37%,var(--edb-dashboard-bg) 63%); background-size: 400% 100%; animation: shimmer 1.4s infinite; border-radius: 8px; margin-bottom: 10px; }
